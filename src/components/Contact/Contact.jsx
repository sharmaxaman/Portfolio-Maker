...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_pblpd0b', 'template_i1vupql', form.current, '-oU_x02esym8AvQVs')
      e.target.reset();
    };
            ...
            <form ref={form} onSubmit={sendEmail}
             className="contact__form">
                 ...
                 <div className="contact__form-div">
                    ...
                    <input type="tel" 
                    className="contact__form-input"
                    name="mobile_number" placeholder="Enter your mobile number" required pattern="[0-9]{10}"
                    />
                 </div>
