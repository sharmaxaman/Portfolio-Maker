...
const Data = () => {
  return (
   <div className="home__data">
    <h1 className="home__title">Rahul Tailor
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
       ...
       <h3 className="home__subtitle">Web and Software Developer</h3>
       <p className="home__description">
       I'm currently pursuing my B.Tech Degree in electronics and communication branch in NIT Kurukshetra and i'm very passionate and dedicated to my work.</p>
